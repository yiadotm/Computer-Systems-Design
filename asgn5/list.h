...
typedef const char *ListElement;
...
int indexs(List L); // Returns index of cursor element if defined, -1 otherwise.
...
void deleteCursor(List L); // Delete cursor element, making cursor undefined.
    // Pre: length()>0, index()>=0
